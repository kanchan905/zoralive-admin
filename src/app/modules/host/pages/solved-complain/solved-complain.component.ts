...
import { SOLVED_COMPLAIN_TABLE_COLUMNS } from '../../constants/solved-complain-table.columns';
import { SolvedComplainService } from '../../services/solved-complain.service';

@Component({
  selector: 'app-solved-complain',
  imports: [
    BreadcrumbComponent,
    PageHeaderComponent,
    SearchBoxComponent,
...
export class SolvedComplainComponent implements OnInit {
  private readonly solvedComplainService = inject(SolvedComplainService);
  ...
  readonly columns = SOLVED_COMPLAIN_TABLE_COLUMNS;
